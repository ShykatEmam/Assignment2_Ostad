...
You have to create two files called string.php and oop.php in the root of your fresh new github repository.

Use the stated variables and templates where it is given. Do not add or modify or rename given elements.

Your output must look like the given output that is given below of each question.
